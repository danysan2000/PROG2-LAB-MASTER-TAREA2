...
void main_obtenerNesimaPersonaABBPersonasTiempo();
...
int main() {
    ...
    while (seguir) {
        ...
        } else if (cmd_es("obtenerNesimaPersonaABBPersonasTiempo", cmd)) {
            main_obtenerNesimaPersonaABBPersonasTiempo();
...
void main_obtenerNesimaPersonaABBPersonasTiempo(){
    ...
    // Test obtenerNesimaPersonaTABBPersonas at different positions
    TPersona persona1 = obtenerNesimaPersonaTABBPersonas(abbPersonas, 1);                // Primera persona
    TPersona persona2 = obtenerNesimaPersonaTABBPersonas(abbPersonas, tamanio);          // Ultima persona
    TPersona persona3 = obtenerNesimaPersonaTABBPersonas(abbPersonas, tamanio / 3);      // 1/3 del arbol
    TPersona persona4 = obtenerNesimaPersonaTABBPersonas(abbPersonas, 2 * tamanio / 3);  // 2/3 del arbol
    ...
    if (tiempo > timeout) {
        ...
        printf("Se obtuvieron las personas en posiciones 1, %d, %d, %d con cedulas respectivas %d %d %d %d\n", 
               tamanio, tamanio / 3, 2 * tamanio / 3, 
               ciTPersona(persona1), ciTPersona(persona2), ciTPersona(persona3), ciTPersona(persona4));
        printf("Calculado correctamente en menos de %.3fs.\n", timeout);    
    }
